...
export default class Php extends Default {
    ...
    generatePhpClass = (resourceConfig: Resource): string => {
        ...
        const interfaceName = this.interfaceData.name;
        const isDeprecated = this.interfaceData.deprecated;
        let abstractPlugin = this.interfaceData.isPlugin ? 'extends \\Spryker\\Zed\\Kernel\\Communication\\AbstractPlugin' : ''
